...
function getElements(tabURL,websiteURL,pvDOM,searchData,sexSearchCallback,productSearchCallback,attemptCount) {
    ...
    if(!lvFoundEverything && attemptCount < 10) {
        ...
        if(runSexSearch) {
            sexSearchCallback(pageElements,websiteURL,productSearchCallback,searchData,logMessage, departmentOverride);
        } else {
 ...
 */
function sexSearch(pageElements, websiteURL, productSearchCallback, searchData, logMessage, departmentOverride) {
 ...
 */
function productSearch(pageElements,websiteURL,searchData,logMessage, departmentOverride) {
